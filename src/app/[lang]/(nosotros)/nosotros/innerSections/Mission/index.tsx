...
export const Mission: FC<LangInterface> = ({ lang }) => {
  return (
    <div className="relative">
      <div className="flex justify-center items-start px-[7.5rem] bg-main-red w-full h-96 back-clip-path max-[744px]:px-14 max-[550px]:px-5 max-[610px]:h-[26.25rem] max-[480px]:h-[42.188rem] max-[380px]:px-6 max-[340px]:h-[43.75rem]">
