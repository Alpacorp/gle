    ...
    <section className="text-center">
      ...
      <div>
        ...
        <h4 className="text-lg font-poppins font-normal">
          ...
          {lang === "es"
            ? "por favor comuníquese al teléfono:"
      ...
      <div className="relative mt-10 pt-40 text-white">
        ...
        >
          ...
          <div className="flex flex-col gap-3 max-w-[500px] w-full mx-auto text-sm text-left">
            <p>
              {lang === "es"
                ? "Con el diligenciamiento del formulario Usted autoriza el tratamiento de datos personales de acuerdo con la ley Estatutaria 1581, puede consultar aquí:"
