        ...
        >
          ...
          <div
            className={`absolute left-4 w-[2px] h-full bg-black ${
              ...
              index === dataTracking?.StatusDelivery.length - 1 && "bottom-16"
            }`}
          />
          <CardTrackingInfo
          ...
          />
          <p className="max-[480px]:text-sm">{status?.Description}</p>
          <hr className="max-w-xs w-full border-1 border-black" />
        </li>
      ))}
    </ul>
  );
