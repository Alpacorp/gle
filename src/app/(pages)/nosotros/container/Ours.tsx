...
import { ValuesText } from "@nosotros/components/ValuesText";

import dataValues from "@nosotros/data/dataValues.json";
      ...
      <div className="">
        ...
        <div className="flex gap-8 items-center px-[120px] mt-14 max-[1000px]:flex-wrap max-[550px]:px-5 max-[380px]:px-[24px]">
          <div className="w-full">
            <Image
              src="/assets/images/filosofia.webp"
              alt="valores"
              width={450}
              height={637}
              priority
        ...
        <div className="mt-28">
          <div className="text-center m-auto">
            ...
            <Image
              src="/assets/images/gle/gle-white.png"
